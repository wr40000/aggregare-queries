  ...
  <div style="height: 42px; margin-top: 10px">
    ...
    <div v-if="false" id="error-bound">
      ...
      >
        ...
        ></el-input>
        <span style="text-align: center; font-size: 12px"> error bound </span>
      </el-col>
    ...
    >
      <el-tooltip content="round by round">
        <el-button
          ...
          @click="change_button_focus(true)"
        >
          同构
        </el-button>
    ...
    >
      <el-tooltip content="round by round">
        <el-button
          ...
          @click="change_button_focus_yg(false)"
        >
          异构
        </el-button>
        <!-- changeStatus('interactive') -->
    ...
    <el-dialog :visible.sync="dialogFormVisible_tg">
      ...
      <div slot="footer" class="dialog-footer">
        <el-button class="el_button_qx" @click="dialogFormVisible_tg = false">
          取 消
        </el-button>
        <el-button
          class="el_button_qd"
          type="primary"
          @click="dialogFormVisible_tg = false"
        >
          确 定
        </el-button>
      </div>
    ...
    <el-dialog :visible.sync="dialogFormVisible_yg">
      ...
      <div slot="footer" class="dialog-footer">
        <el-button class="el_button_qx" @click="dialogFormVisible_yg = false">
          取 消
        </el-button>
        <el-button
          class="el_button_qd"
          type="primary"
          @click="dialogFormVisible_yg = false"
        >
          确 定
        </el-button>
      </div>
      ...
      <el-tooltip v-if="status === 'interactive'" content="continue">
        ...
        >
          <svg
            ...
            fill="#fff"
          >
            <path d="M104 0v1024l816-512z" p-id="2865"></path>
          </svg>
        </el-button>
      </el-tooltip>
    </el-col>
  ...
  methods: {
    errorBoundClick() {
      if (this.maxRound !== 0 && this.model !== "interactive model") {
        ...
        this.$message.error(
          "No query was submitted or another model has been chosen!"
        );
      }
    },
    modeSelect(mode) {
